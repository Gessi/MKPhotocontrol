...
public class MKWaypointPainter<T extends JXMapViewer> extends AbstractPainter<T> {
	private MKWaypointRenderer renderer = new MKWaypointRenderer();
    private Set<MKWaypoint> waypoints;
    
    /**
     * Creates a new instance of MKWaypointPainter
     */
    public MKWaypointPainter()
    {
     ...
     */
    public void setRenderer(MKWaypointRenderer r) 
    {
        this.renderer = r;
    }
     ...
     */
    public Set<MKWaypoint> getWaypoints() {
     ...
     */
    public void setWaypoints(Set<MKWaypoint> waypoints) {
     ...
     */
    protected void paintWaypoint(final MKWaypoint w, final T map, final Graphics2D g) 
    {
